...
class ProgressProcedure(_bundle: com.github.iamniklas.liocorekotlin.led.LEDDataBundle) : com.github.iamniklas.liocorekotlin.procedures.Procedure(_bundle) {
    private var mStart = 0.0f
    private var mProgress = 0.0f
    private val mColor: com.github.iamniklas.liocorekotlin.led.ColorRGB?
    ...
    public override fun update() {
        ...
        if (mPulsing) {
            ...
            mStrip!!.setArea(
                (com.github.iamniklas.liocorekotlin.led.LEDStripManager.LED_COUNT * mStart).toInt(),
                (com.github.iamniklas.liocorekotlin.led.LEDStripManager.LED_COUNT * mProgress).toInt(),
            ...
            mStrip!!.setArea(
                Math.min(Math.max((com.github.iamniklas.liocorekotlin.led.LEDStripManager.LED_COUNT * mStart).toInt(), 0), 300),
                Math.min(Math.max((com.github.iamniklas.liocorekotlin.led.LEDStripManager.LED_COUNT * mProgress).toInt(), 0), 300),
